  ...
  return (
    <>
      ...
      {/* Mobile Overlay */}
        ...
        {/* breadcrumb */}
        <Breadcrumb title="Page Not Found" pageName="404" />


        {/*404 content*/}
        <section className="ta-404 pta-120 bg-cover" style={{backgroundImage: "url(/images/404-bg.jpg)"}}>
            <div className="container">
                <div className="ta-404-wrapper">
                    <div className="row">
                        <div className="col-12">
                            <div className="ta-404-content">
                                <h1 className="txt-anim-2" data-aos="fade-up" data-aos-duration="600">
                                    404</h1>
                                <h2 className="txt-anim-2" data-aos="fade-up" data-aos-duration="600">
                                    Sorry, something went wrong!</h2>
                                <p className="text text-center mb-30" data-aos="fade-up" data-aos-duration="600">Sorry,
                                    something went wrong. The page you’re looking for might be missing, moved, or under
                                    maintenance. <br /> Please try again or return to the homepage for navigation</p>
                                <a href="/" className="ta-button-02 d-none d-xl-flex">
                                    Back To Home
                                    <span className="button__icon-wrapper">
                                        <svg viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="button__icon-svg" width="10">
                                            <path d="M13.376 11.552l-.264-10.44-10.44-.24.024 2.28 6.96-.048L.2 12.56l1.488 1.488 9.432-9.432-.048 6.912 2.304.024z" fill="currentColor"></path>
