window.initializeHeaderEffects = function () {
  ...
  $('.nav-menu .sub-menu > li.has-sub').not('.mega-menu .sub-menu > li').off('.tfbL2');
  ...
  $('.nav-menu .sub-menu .sub-menu > li.has-sub').not('.mega-menu .sub-menu > li').off('.tfbL3');
  ...
  $mClose.off('.tfbMClose');
  $mClose.on('click.tfbMClose', closeDrawer);

  $overlay.off('.tfbOverlay');
