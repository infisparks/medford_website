                ...
                <div className="ta-team-three-wrap">
                    <div className="row gy-30 align-items-center justify-content-center">
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="300">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-01.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Christopher Caitlin</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="400">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-02.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Stephanie Holmgren</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="500">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-03.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Rodger Quintanilla</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="600">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-04.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Nolan Mathewson</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="300">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-05.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Edward Creighton</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="400">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-06.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Trenton Robinson</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="500">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-07.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Robert Villarreal</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="600">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-08.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Barbara Patrick</h2>
                                    </a>
                                    <span>Chief Cardiac Surgeon</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="300">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-09.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Cecil Letourneau</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="400">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-10.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Samantha Grant</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="500">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-11.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Brian Gildersleve</h2>
                                    </a>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-duration="600">
                            <div className="team-three-item">
                                <div className="image-hover-effect main-image">
                                    <img src="/images/team-12.png" className="img-fluid w-100" alt="team image" />
                                    <ul className="icons">
                                        <li><a href="#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="#"><i className="fa-brands fa-instagram"></i></a></li>
                                ...
                                <div className="info">
                                    <a href="/team-single">
                                        <h2 className="header-md">Margaret Gibbon</h2>
                                    </a>
